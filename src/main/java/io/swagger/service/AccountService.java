...
public class AccountService {
  ...
  public List<Account> getUserAccounts(String username) {
    ...
    if (!accounts.isEmpty()) {
      ...
      throw new ResponseStatusException(HttpStatus.UNPROCESSABLE_ENTITY, "No accounts found for user: " + username);
    }
  }
  ...
  public Account getAccountByIban(String iban) {
    ...
    if (account != null) {
      ...
      throw new ResponseStatusException(HttpStatus.UNPROCESSABLE_ENTITY, "No accounts found for iban: " + iban);
    }
  }
}
